# UNICRED — NOC Command Center

Projeto de monitoramento operacional da organização **Unicred** via Power BI e relatórios periódicos do NOC.
...
UNICRED/
├── Dashboard/
│   └── Métricas NOC - UNICRED.pbix        — dashboard Power BI
├── elven-decks-main/                    — código-fonte da skill de decks
├── Relatórios/
│   ├── _template-noc/                   — TEMPLATE PADRÃO (base para novos decks)
│   │   └── deck.html
│   ├── noc-unicred-DDMMAAAA/              — um deck por dia
│   │   ├── Relatorio_NOC_Unicred_DDMMAAAA.docx
│   │   ├── deck.html
│   │   ├── elven-deck.css
│   │   ├── elven-deck-charts.js
│   │   ├── noc-unicred-DDMMAAAA.pdf
│   │   ├── source-notes.md
│   │   ├── qa-notes.md
│   │   └── assets/
...
path = "Relatorio_NOC_Unicred_DDMMAAAA.docx"
...
```powershell
Move-Item "Relatorio_NOC_Unicred_DDMMAAAA.docx" "Relatórios\<slug>\"
```
...
**Deck de referência visual**: `Relatórios/noc-unicred-23062026/` (23/06/2026) — estrutura antiga de 6 slides, usar apenas para referência de CSS/assets.
